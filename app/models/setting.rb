...
class Setting < ActiveRecord::Base
  ...
  def self.use_caching?
    !Thread.current['Romeoproject/settings/do_not_use_caching']
  end

  # Dis-/En-able Setting caching. This is mainly intended to be used in tests
  def self.use_caching=(new_value)
    Thread.current['Romeoproject/settings/do_not_use_caching'] = !new_value
  end
...
private
  ...
  def self.cache_key(name)
    "Romeoproject/setting/#{Setting.maximum(:updated_on).to_i}/#{name}"
  end
end
