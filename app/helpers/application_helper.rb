...
module ApplicationHelper
  ...
  def textilizable(*args)
    ...
    begin
      text = RomeoProject::Liquid::Legacy.run_macros(input_text)
      liquid_template = RomeoProject::Liquid::Template.parse(text)
      ...
      liquid_variables.merge!(RomeoProject::Liquid::Variables.all)
  ...
  # Returns options or nil if nometa param or X-RomeoProject-Nometa header
  # was set in the request
  def api_meta(options)
    if params[:nometa].present? || request.headers['X-RomeoProject-Nometa']
