...
* Bug #1194: Problems migrating from Romeo 2.0.0 to 3.3.0
* Security – Bug #1195: SQL Injection Vulnerability in Ruby on Rails (CVE-2012-5664)
* Bug #1197: Links to new and existing Pages in Romeo wikis have the same color. Thats boring.
...
* Bug #1074: Rake tasks of plugins in vendor/Romeoproject_plugins are not loaded
...
* Task #982: Updated czech localization for Romeoproject 3.1
...
* Bug #748: RomeoProject::VERSION.revision doesn't capture error output
...
* Feature #275: Implement requires_Romeoproject and requires_Romeoproject_plugin methods
...
* Bug #540: Hook helper_issues_show_detail_after_setting gets different parameters in Romeo 1.x and 2.0
...
* Bug #425: Deprecation warning when using RomeoProject with Rake 0.9
* Feature #202: Adding the theme used on Romeoproject.org to the repository
...
* Bug #251: Make Romeo work with RubyGems 1.6
...
* Feature #101: Change the Help link to point to the RomeoProject site
* Feature #104: Add email header for the type of message
* Feature #129: Change public strings of Redmine to RomeoProject
...
Note: Previous versions referred to Redmine, which RomeoProject forked from in December 2010.
